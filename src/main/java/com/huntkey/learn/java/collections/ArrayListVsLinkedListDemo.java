package com.huntkey.learn.java.collections;
...
public class ArrayListVsLinkedListDemo {
    ...
    public static void main(String[] args) {
        ...
        int[] arrSize = new int[]{10000, 100000, 1000000, 3000000, 5000000, 10000000, 20000000};
        ...
        //    System.out.println("get LinkedList with " + size + " objects randomly cost: " + cost + " ms.");
        //}
    }
